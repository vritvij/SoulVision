...
def get_moves_probability(input_json_obj):
    json_obj = json.load(input_json_obj)
    ...
    # retrieve data from json obj into features
...
"""
    ...
    with graph.as_default():
        with tf.Session() as sess:
            ...
            print(prediction)
            newdata=example
            output = sess.run(prediction,feed_dict={'Placeholder:0':newdata})
